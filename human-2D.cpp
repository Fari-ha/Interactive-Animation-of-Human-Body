...
#include<math.h>
#define fi 4
// Define constants for body parts
const int HEAD = 0;
const int TORSO = 1;
const int ARM_LEFT = 2;
const int ARM_RIGHT = 3;
void desc();
void mymenu();
int flag = 0;
...
// This function returns the name of the body part.
const char* get_body_part_name(int body_part) {
    switch (body_part) {
    case HEAD: return "head";
    case TORSO: return "torso";
    case ARM_LEFT: return "left arm";
    case ARM_RIGHT: return "right arm";
    default: return "unknown";
    }
}

// This function is called 1st whenever we run the program.
void frontscreen(void)
{
    glClear(GL_COLOR_BUFFER_BIT);
    glColor3f(0, 0, 1);
    drawstring(-37, 40, 0.0, "International University of Business Agriculture and Technology");
    glColor3f(0.7, 0, 1);
    drawstring(-30, 35, 0.0, "Department of Computer Science and Engineering ");
    glColor3f(1, 0.5, 0);
    drawstring(-10, 30, 0.0, "Project on: ");
    glColor3f(1, 0, 0);
    drawstring(-25, 20, 0.0, "Interactive Animation of Human Body");
    glColor3f(1, 0.5, 0);
    drawstring(-35, 0, 0.0, "Presented BY:");
    glColor3f(0.5, 0, 0.5);
    drawstring(-35, -10, 0.0, "Team Alpha");
    strflag = 0;
    //drawstring(-35,-14,0.0," ");
    glColor3f(1, 0.5, 0);
    drawstring(15, 0, 0.0, "Faculty:");
    glColor3f(0.5, 0.2, 0.2);
    drawstring(15, -10, 0.0, "Mr. Krishna Das");
    strflag = 0;
...
//This function is for drawing the human body.
void body()
{
    GLfloat i, x, y;
    glColor3f(0, 0, 0);
...
//Function for drwaing Digestive system
GLfloat aa, bb;
void digesdraw()
{
    GLfloat i;
...
// Function for digestive system description 
void descDigest()
{
    ...
    drawstring(-35, 30, 0.0, " Following are the steps of Disgestive system :");
    glColor3ub(0, 207, 119);
    drawstring1(-35, 25, 0.0, "1. Chewing ");
    glColor3f(0, 0, 0);
    strflag = 0;
    drawstring1(-24, 25, 0.0, "is the first stage of the digestive system. When food is chewed, it breaks up big pieces ");
...
//Function for drawing Respiratory System
...
void desc()
{
    ...
    glColor3ub(58, 62, 73);
    strflag = 1;
    drawstring1(-25, 45, 0.0, "HUMAN ANATOMY ");
